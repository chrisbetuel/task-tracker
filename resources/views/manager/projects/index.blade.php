...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Projects</h2>
    <a href="{{ route('manager.projects.create') }}" class="btn btn-primary">Create Project</a>
</div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr class="table-primary">
                        ...
                        <td>
                            <a href="{{ route('manager.projects.show', $project) }}" class="btn btn-sm btn-info">View</a>
                            <a href="{{ route('manager.projects.edit', $project) }}" class="btn btn-sm btn-warning">Edit</a>
                        </td>
                    </tr>
                    @if($project->children->count())
                        ...
                        <tr>
                            <td class="ps-5 text-nowrap">
                                <a href="{{ route('manager.projects.show', $child) }}">
                            ...
                            <td>
                                <a href="{{ route('manager.projects.show', $child) }}" class="btn btn-sm btn-info">View</a>
                                <a href="{{ route('manager.projects.edit', $child) }}" class="btn btn-sm btn-warning">Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    @endif
