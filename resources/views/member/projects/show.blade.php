...
<div class="card mb-4">
    ...
    <div class="card-body">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><a href="{{ route('member.projects.show', $child) }}">{{ $child->name }}</a></li>
            @endforeach
        </ul>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="text-center py-4">
            ...
            @endif
            <a href="{{ route('member.tasks.create') }}?project_id={{ $project->id }}" class="btn btn-primary btn-sm">
